...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      id: 'ofurH5jVPAB-hPEHw5sacc1aKAWM',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'th4abxdhUEaNVDwo3L5nvbrLKKhEyzdyDqvLo3wIoiU',
      // 所在省份
      province: '湖北',
      // 所在城市
      city: '武汉',
      ...
      festivals: [
        ...
        {
          type: '生日', name: '凯霸霸', year: '1998', date: '08-26',
        }
      ],
  ...
  CALLBACK_USERS: [
    {
      // 一般都填自己
      name: 'ofurH5nOct3pMkjUJlnyhpaTpjQk',
